    ...
    render() {
        return (
            <TouchableOpacity  onPress={() => this.props.onPress(this.props.story.id,this.props.story.name)}>
                <View  style={{ flex: 1,marginBottom:10,marginHorizontal:5,marginTop:10, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 10,borderRadius:10,backgroundColor: '#22272b' }}>
